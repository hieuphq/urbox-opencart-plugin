...
class ControllerExport extends Controller {
    /**
     * Function to generate xml for order export to urbox
     * 
     * @return xml
     */
    public function index() {
        ...
        //Generate the xml from the order data to export into the urbox
        ...
        if (!empty($orders)) {
            foreach ($orders as $order) {
                ...
                if (!empty($order_data) && isset($order_data['Items']) && !empty($order_data['Items'])) {
                    $xml .= '<Order>' . "\n";
